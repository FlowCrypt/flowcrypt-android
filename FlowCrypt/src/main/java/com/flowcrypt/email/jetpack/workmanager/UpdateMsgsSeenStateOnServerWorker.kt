 ...
 */
class UpdateMsgsSeenStateOnServerWorker(context: Context, params: WorkerParameters) : BaseSyncWorker(context, params) {
    ...
    fun enqueue(context: Context) {
      ...
      WorkManager
          ...
          .enqueueUniqueWork(
              ...
              OneTimeWorkRequestBuilder<UpdateMsgsSeenStateOnServerWorker>()
                  .addTag(TAG_SYNC)
