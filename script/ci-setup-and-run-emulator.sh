...
echo -ne '\n' | avdmanager -v create avd --name ci-test-pixel-x86-64-api29 --package "system-images;android-29;google_apis;x86_64" --device 'pixel_xl' --abi 'google_apis/x86_64'
...
echo "hw.ramSize=3064"  >> ~/.android/avd/ci-test-pixel-x86-64-api29.avd/config.ini
cat ~/.android/avd/ci-test-pixel-x86-64-api29.avd/config.ini
