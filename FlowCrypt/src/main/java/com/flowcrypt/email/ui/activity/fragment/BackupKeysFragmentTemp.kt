...
import com.flowcrypt.email.databinding.FragmentBackupKeysTempBinding
 ...
 */
class BackupKeysFragmentTemp : BaseFragment(), ProgressBehaviour {
  private var binding: FragmentBackupKeysTempBinding? = null
  ...
  override val contentResourceId: Int = R.layout.fragment_backup_keys_temp

  override fun onCreateView(
    inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?
  ): View? {
    binding = FragmentBackupKeysTempBinding.inflate(inflater, container, false)
    return binding?.root
  }
