 ...
 */
public final class LoggingInFileInterceptor implements Interceptor {
  private static final Charset UTF8 = Charset.forName("UTF-8");
  private final Logger logger;
  private volatile Level level = Level.NONE;

  public LoggingInFileInterceptor() {
    this(Logger.DEFAULT);
  }

  public LoggingInFileInterceptor(Logger logger) {
    this.logger = logger;
  }
   ...
   */
  public LoggingInFileInterceptor setLevel(Level level) {
  ...
  interface Logger {
    ...
    Logger DEFAULT = new Logger() {
      private final DebugLogWriter debugLogWriter = new DebugLogWriter("API");
