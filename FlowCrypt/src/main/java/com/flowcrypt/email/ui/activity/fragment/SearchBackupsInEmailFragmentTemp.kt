...
import com.flowcrypt.email.databinding.FragmentSearchBackupsInEmailTempBinding
 ...
 */
class SearchBackupsInEmailFragmentTemp : BaseFragment(), ProgressBehaviour {
  private var binding: FragmentSearchBackupsInEmailTempBinding? = null
  ...
  override val contentResourceId: Int = R.layout.fragment_search_backups_in_email_temp
  ...
  override fun onCreateView(
    ...
    binding = FragmentSearchBackupsInEmailTempBinding.inflate(inflater, container, false)
    return binding?.root
  }
  ...
  private fun initViews() {
    binding?.btBackup?.setOnClickListener {
      navController?.navigate(
        SearchBackupsInEmailFragmentTempDirections
