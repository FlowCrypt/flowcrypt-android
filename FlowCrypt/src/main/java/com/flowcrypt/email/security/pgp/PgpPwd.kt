...
object PgpPwd {
    ...
    fun estimateStrength(guesses: BigInteger, type: PwdType = PwdType.PASSPHRASE):
            PwdStrengthResult {
    ...
    // Generates random password using digits and uppercase English letters,
    // for example: TDW6-DU5M-TANI-LJXY
    fun random(): String {
    ...
    private fun readableCrackTime(totalSeconds: BigInteger): String {
        ...
        val millennia = n.div(SECONDS_PER_MILLENIUM).setScale(0, RoundingMode.HALF_UP)
    ...
    private const val DAYS_PER_YEAR = 12 * DAYS_PER_MONTH
    private val SECONDS_PER_MILLENIUM = BigDecimal(86400L * DAYS_PER_YEAR * 100 * 1000)
    private val SECONDS_PER_CENTURY = BigDecimal(86400L * DAYS_PER_YEAR * 100)
    private val SECONDS_PER_YEAR = BigDecimal(86400L * DAYS_PER_YEAR)
    private val SECONDS_PER_MONTH = BigDecimal(86400 * 30)
    private val SECONDS_PER_WEEK = BigDecimal(86400 * 7)
