...
echo -ne '\n' | avdmanager -v create avd --name ci-emulator --package "system-images;android-30;google_apis;x86_64" --device 'pixel_xl' --abi 'google_apis/x86'
cat ~/.android/avd/ci-emulator.avd/config.ini
echo "vm.heapSize=256"  >> ~/.android/avd/ci-emulator.avd/config.ini
